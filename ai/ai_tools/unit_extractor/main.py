"""Standalone menu-driven runner for the unit extractor.

This script exposes a small interactive CLI used during development to
choose input directories and serialization formats. It is intentionally
simple and retains its existing interactive behavior; comments and
docstrings were added to improve readability.
"""
